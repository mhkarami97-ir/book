...
به‌همین دلیل نویسنده توصیه می‌کند مرتباً **نشانه‌های پیشرفت کوچک** را ثبت کنی (مثلاً: «جان امروز در رِترو حرف زد»، «آدم‌ها در دیلی به‌جای کفش‌ها، به هم نگاه می‌کنند»، «Dave امروز داوطلب شد به Arush کمک کند»). 
این ریزپیشرفت‌ها در روزهای سخت، سوخت تو هستند.
...
- یک دیوار Sprint Backlog، دیوار Burndown، و روی دیوار دیگر خروجی رِتروهای قبلی است. 
همه سر وقت می‌آیند، حتی PO یعنی **Annika**. 
...
در این نوبت می‌رویم سراغ ادامه‌ی داستان Annika و Stephanie و **مدل SPEED** برای تأثیرگذاری حساب‌شده، و همچنین بخش **«Respected»** که یکی از ستون‌های نفوذ اسکرام‌مستر است.

## ۱. ادامه‌ی گفت‌وگوی Annika و Stephanie: SPEED Model

در ادامه‌ی داستان قبل، Annika از Stephanie می‌خواهد او **Jean** (مدیر بالای او) را متقاعد کند که هدف quarter بعدی غیرواقعی است و تیم را اذیت نکند. 
Stephanie قبول نمی‌کند که خودش وارد شود، چون: 
...
- **S**uggestions: پیشنهادها/دستورات  
- **P**roof: اثبات با داده و شواهد  
- **E**nablers: فعال‌کننده‌ها / ابزارها  
- **E**nvironment: تغییر محیط  
- **D**rivers: محرک‌های درونی فرد  
...
نکته‌ی جالب این است که انتخاب تیم، اغلب با انتخاب مدیریت فرق می‌کند! 
نویسنده پیشنهاد می‌کند: 
...
الان می‌رویم سراغ بخش‌های پایانی مدل **RETRAINED**، یعنی **«Encourage»** و **«Facilitate»**، که جمع‌بندی نهایی ویژگی‌های اسکرام‌مستر عالی هستند.
...
| **E** | **Enabling** | توانمندساز، نه انجام‌دهنده |
| **T** | **Tactful** | باهوش و محتاط در تأثیرگذاری |
| **R** | **Respected** | محترم و قابل‌اعتماد |
| **A** | **Alternative** | آلترناتیو: دیدگاه و راه‌حل متفاوت |
| **I** | **Inspiring** | الهام‌بخش |
| **N** | **Nuanced** | ظریف و عمیق در درک |
| **E** | **Encourage** | تشویق‌کننده |
